...
/// A class that contains all theme configurations for the automotive service marketplace application.
class AppTheme {
  AppTheme._();

  // Automotive service marketplace color palette - Trustworthy Depth theme
  // Primary colors
  ...
  // Secondary colors
  static const Color secondaryLight = Color(0xFF64748B); // Balanced slate gray
  static const Color secondaryDark =
      Color(0xFF94A3B8); // Lighter slate for dark theme

  // Accent and status colors
  static const Color accentColor =
      Color(0xFFF59E0B); // Warm amber for urgent notifications
  static const Color successColor =
      Color(0xFF10B981); // Clean emerald for completed services
  static const Color warningColor =
      Color(0xFFF97316); // Clear orange for important alerts
  static const Color errorLight = Color(0xFFEF4444); // Direct red for errors
  static const Color errorDark = Color(0xFFF87171); // Softer red for dark theme

  // Background and surface colors
  static const Color backgroundLight = Color(0xFFF8FAFC); // Soft off-white
  static const Color backgroundDark =
      Color(0xFF0F172A); // Deep blue-gray for dark theme
  static const Color surfaceLight = Color(0xFFFFFFFF); // Pure white
  static const Color surfaceDark = Color(0xFF1E293B); // Dark blue-gray surface

  // Text colors
  static const Color textPrimaryLight = Color(0xFF1F2937); // Dark charcoal
  static const Color textSecondaryLight = Color(0xFF6B7280); // Medium gray
  static const Color textPrimaryDark =
      Color(0xFFF8FAFC); // Light text for dark theme
  static const Color textSecondaryDark =
      Color(0xFF94A3B8); // Medium gray for dark theme
  ...
  /// Light theme for automotive service marketplace
  static ThemeData lightTheme = ThemeData(
    ...
    // Bottom navigation for mechanic/user switching
    ...
    // Input decoration for service forms and booking
    ...
    // Checkbox theme for service selections
    ...
    // Radio theme for service options
    ...
    // Progress indicators for service status
    ...
    // Bottom sheet theme for service details
  ...
  /// Dark theme for automotive service marketplace
  static ThemeData darkTheme = ThemeData(
    ...
    // Card theme with subtle shadows for dark mode
    cardTheme: CardTheme(
      color: cardDark,
      elevation: 2.0,
      shadowColor: shadowDark,
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles for service titles and headers
  ...
  /// Helper method to get data text style using JetBrains Mono for prices and technical specs
  ...
  /// Helper method to get status colors for service states
